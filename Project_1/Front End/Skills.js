        ...
        data[1].forEach(function(item,index){
          ...
          <div class="col-2">
            <div class="edutoolbar">
                <button style= "border:white; background-color:white;"  type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight${count}" aria-controls="offcanvasRight"><i style="font-size: 1rem;" class="bi  bi-pencil-fill  edicon"></i></i></button>

                <div style="background-color: white;" class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight${count}" aria-labelledby="offcanvasRightLabel">
                  ...
                  <div>
                    <div class="form">
                        ...
                        <form  class="login-form" name="formcontact1">
                            ...
                            <input type="text" placeholder="Skill On a Scale of 1 to 10" value=${item.skillExperience} id = "uaddsexperience${count}"/>
