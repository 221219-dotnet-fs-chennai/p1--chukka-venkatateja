        ...
        data[3].forEach(function(item,index){
          ...
          <div class="col-2">
            <div class="edutoolbar">
                <button style= "border:white; background-color:white;"  type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight${count}" aria-controls="offcanvasRight"><i style="font-size: 1.1rem;" class="bi  bi-pencil-fill  edicon"></i></i></button>
