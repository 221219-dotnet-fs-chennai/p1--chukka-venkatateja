...
namespace UserProfile
{
    ...
    public class AddCompany
    {
        public void CompanyAdder(int usid)
        {
            ...
            string skill_name = sq.SqlQueryWriterSkill($"Insert into venkat.comp(about,comp_name,start_date,end_date,us_id) Values('{CompAbout}','{CompName}','{CompStart}','{CompEnd}',{usid});");
            skill_name = sq.SqlQueryWriterSkill($"SELECT * from venkat.comp;");
    ...
    public class UpdateCompany
    {
        public void CompanyUpdate(int usid)
        {
            ...
            DataTable reader = sq.SqlQeryWriterSkillUpdate($"select k.comp_id,k.comp_name,k.about,k.start_date,k.end_date from venkat.comp as k WHERE k.us_id = {usid};");
            ...
            sq.sqlQueryDelete($"UPDATE venkat.comp SET about = '{resabout}', comp_name = '{resname}', start_date = '{resstart}', end_date = '{resend}' WHERE comp_id = {res};");
    ...
    public class DeleteCompany
    {
        public void CompanyDelete(int usid)
        {
            ...
            sq.sqlQueryDelete($"DELETE FROM venkat.comp WHERE comp_id ={skill_id}");
