...
namespace trainer
{
...

    {
        ...
        public void SignUpPageSubmission()
        {
            try
            {
                int reader = sq.SqlQueryWriter($"INSERT into venkat.[user](first_name,last_name,email_id,[password],phone_no) VALUES('{this.firstname}','{this.lastname}','{this.emailid}','{this.password}','{this.phoneno}');");
